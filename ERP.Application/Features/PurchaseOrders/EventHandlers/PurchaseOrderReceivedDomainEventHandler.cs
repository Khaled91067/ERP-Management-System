...
public sealed class PurchaseOrderReceivedDomainEventHandler
    : IDomainEventHandler<PurchaseOrderReceivedDomainEvent>
{
    private readonly IPurchaseOrderRepository _purchaseOrderRepository;
    private readonly IGenericRepository<Product> _productRepository;

    public PurchaseOrderReceivedDomainEventHandler(
    ...
    public async Task Handle(
        DomainEventNotification<PurchaseOrderReceivedDomainEvent> notification,
