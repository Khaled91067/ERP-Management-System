...
namespace ERP.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260728192436_RemoveHasDataSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Domain.Catalog.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Domain.Sales.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ERP.Domain.Catalog.Products.Product", b =>
                {
                    b.HasOne("ERP.Domain.Catalog.Categories.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ERP.Domain.HR.Employees.Employee", b =>
                {
                    b.HasOne("ERP.Domain.HR.Departments.Department", "Department")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("ERP.Domain.Identity.Users.RefreshToken", b =>
                {
                    b.HasOne("ERP.Domain.Identity.Users.User", "User")
            ...
            modelBuilder.Entity("ERP.Domain.Identity.Users.User", b =>
                {
                    b.HasOne("ERP.Domain.Identity.Roles.Role", "Role")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("ERP.Domain.Purchasing.PurchaseOrders.PurchaseOrder", b =>
                {
                    b.HasOne("ERP.Domain.Purchasing.Suppliers.Supplier", "Supplier")
            ...
            modelBuilder.Entity("ERP.Domain.Purchasing.PurchaseOrders.PurchaseOrderLine", b =>
                {
                    b.HasOne("ERP.Domain.Catalog.Products.Product", "Product")
                        .WithMany("PurchaseOrderLines")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ERP.Domain.Purchasing.PurchaseOrders.PurchaseOrder", "PurchaseOrder")
                        .WithMany("PurchaseOrderLines")
            ...
            modelBuilder.Entity("ERP.Domain.Sales.Invoices.Invoice", b =>
                {
                    b.HasOne("ERP.Domain.Sales.Customers.Customer", "Customer")
                        .WithMany("Invoices")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ERP.Domain.Sales.Orders.Order", "Order")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("ERP.Domain.Sales.Invoices.InvoiceLine", b =>
                {
                    b.HasOne("ERP.Domain.Sales.Invoices.Invoice", "Invoice")
